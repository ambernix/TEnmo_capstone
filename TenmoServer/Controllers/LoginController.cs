...
namespace TenmoServer.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Register(LoginUser userParam)
        {
            ...
            // Adds user and creates account in separate steps. If connection breaks between steps
            // functionality exists for user to create an account after logging in.
            User user = userDao.AddUser(userParam.Username, userParam.Password);
            accountDao.CreateAccount(user.UserId);
